import{e as z,f as Q,B as m,r as b,L as h,a as H,P as y,C as T,S as O,H as D,l as $,p as U,b as F}from"../shared/langchainjs.57b25786.mjs";export{c as ConversationChain}from"../shared/langchainjs.57b25786.mjs";import"path";import"tty";import"util";import"fs";import"net";import"events";import"stream";import"zlib";import"buffer";import"string_decoder";import"querystring";import"url";import"http";import"crypto";import"https";import"assert";import"prompts";import"node:fs/promises";import"node:path";import"child_process";class B{constructor(e){Object.defineProperty(this,"pageContent",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"metadata",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),this.pageContent=e?.pageContent??this.pageContent,this.metadata=e?.metadata??{}}}const G=/lc(@[^:]+)?:\/\/(.*)/,V="/",W=async(i,e,t,n,r={})=>{const o=i.match(G);if(!o)return;const[a,s]=o.slice(1),u=a?a.slice(1):process.env.LANGCHAIN_HUB_DEFAULT_REF??"master";if(s.split(V)[0]!==t)return;if(!n.has(z(s).slice(1)))throw new Error("Unsupported file type.");const l=[process.env.LANGCHAIN_HUB_URL_BASE??"https://raw.githubusercontent.com/hwchase17/langchain-hub/",u,s].join("/"),p=await Q(l,{timeout:5e3});if(p.status!==200)throw new Error(`Could not find file at ${l}`);return e(await p.text(),s,r)};class d extends m{get inputKeys(){return[this.inputKey,...this.llmChain.inputKeys]}constructor(e){super(),Object.defineProperty(this,"llmChain",{enumerable:!0,configurable:!0,writable:!0,value:void 0}),Object.defineProperty(this,"inputKey",{enumerable:!0,configurable:!0,writable:!0,value:"input_documents"}),Object.defineProperty(this,"outputKey",{enumerable:!0,configurable:!0,writable:!0,value:"output_text"}),Object.defineProperty(this,"documentVariableName",{enumerable:!0,configurable:!0,writable:!0,value:"context"}),this.llmChain=e.llmChain,this.documentVariableName=e.documentVariableName??this.documentVariableName,this.inputKey=e.inputKey??this.inputKey,this.outputKey=e.outputKey??this.outputKey}async _call(e){if(!(this.inputKey in e))throw new Error(`Document key ${this.inputKey} not found.`);const{[this.inputKey]:t,...n}=e,o=t.map(({pageContent:s})=>s).join(`
