export const funcPromptTempalte = `A wrapper for Tezign actions.The input to this tool is a natural language instruction, ` +
...
"This tool specifically used for: {description}, " +
